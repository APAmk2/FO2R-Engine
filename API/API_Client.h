...
EXPORT Sprite* Sprites_InsertSprite(Sprites* sprites, int draw_order, int hx, int hy, int cut, int x, int y, uint id, uint* id_ptr, short* ox, short* oy, uchar* alpha, Effect* effect, bool* callback );
...
EXPORT size_t HexMngr_GetAllItems_ScriptArray(CScriptArray* items);
