...
#define DRAW_ORDER_FLAT_ITEM         ( DRAW_ORDER_FLAT + 10 )
#define DRAW_ORDER_DEAD_CRITTER      ( DRAW_ORDER_FLAT + 13 )
...
#define DRAW_ORDER_EFFECT            ( DRAW_ORDER + 11 )
#define DRAW_ORDER_RAIN              ( DRAW_ORDER + 12 )
#define DRAW_ORDER_LAST              ( 39 )
#define DRAW_ORDER_ITEM_AUTO( i )     ( i->IsEffect() ? DRAW_ORDER_EFFECT : (i->IsFlat() ? ( i->IsItem() ? DRAW_ORDER_FLAT_ITEM : DRAW_ORDER_FLAT_SCENERY ) : ( i->IsItem() ? DRAW_ORDER_ITEM : DRAW_ORDER_SCENERY ) ) )
