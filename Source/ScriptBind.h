...
BIND_ASSERT( engine->RegisterObjectMethod( "Critter", "bool TransitToMap(uint mapId, int entireNum, uint8 radius = 2, bool withGroup = false)", asFUNCTION( BIND_CLASS Crit_TransitToMapEntire ), asCALL_CDECL_OBJFIRST ) );
...
BIND_ASSERT( engine->RegisterObjectMethod( "Critter", "bool IsOnline()", asFUNCTION( BIND_CLASS Cl_IsOnline ), asCALL_CDECL_OBJFIRST ) );
